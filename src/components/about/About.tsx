...
import icon from '../../assets/img/chialite_circle.svg';
    ...
    <html>
      ...
      <body>
        ...
        <div className="copyright">
          Copyright (c) 2021 Chialite Network
        </div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
        ...
        <BugReport href="https://github.com/Chialite-Network/chialite-blockchain/issues" target="_blank">
          Report an issue
        </BugReport>
        {'{{CSS}}'}
      </body>
